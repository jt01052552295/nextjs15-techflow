...
import { CreateType, CreateSchema } from '@/actions/badge/create/schema';
import { createAction } from '@/actions/badge/create';
    ...
    startTransition(async () => {
      try {
        ...
        if (response.status == 'success') {
          ...
          // queryClient.setQueryData(badgeQK.detail(newItem.uid), newItem);
