...
export default function CreateForm() {
  ...
  const methods = useForm<CreateTodosType>({
    mode: 'onChange',
    resolver: zodResolver(CreateTodosSchema(dictionary.common.form)),
    defaultValues: {
      uid: uuidv4(),
      email: 'test@test.com',
      name: 'jtm',
  ...
  const { handleInputChange, getInputClass } = useFormUtils<CreateTodosType>({
    trigger,
    errors,
    watch,
    setErrorMessage,
  ...
  const formAction: SubmitHandler<CreateTodosType> = (data) => {
