...
import { UpdateType, UpdateSchema } from '@/actions/category/update/schema';
import { updateAction } from '@/actions/category/update';
import {
  FormProvider,
  SubmitHandler,
  useForm,
    ...
    startTransition(async () => {
      try {
        ...
        if (response.status == 'success') {
          const updatedItem = response.data as ICategory;
          ...
          queryClient.setQueryData(
            categoryQK.detail(updatedItem.uid),
            updatedItem,
          );
