...
import { fetchAllBlogCategoryAction } from '@/actions/blog/category/list';
...
const BlogCategorySelect: React.FC<SelectProps> = ({
  name,
  control,
  defaultValue = '',
  disabled = false,
  ...
  const { data: list = [], isLoading } = useQuery({
    queryKey: ['all-blog-categires', 'active'],
    queryFn: async () => {
      return await fetchAllBlogCategoryAction();
    },
