...
import {
  CreateType,
  CreateSchema,
} from '@/actions/blog/category/create/schema';
import { createAction } from '@/actions/blog/category/create';
    ...
    startTransition(async () => {
      try {
        ...
        if (response.status == 'success') {
          ...
          // queryClient.setQueryData(blogCategoryQK.detail(newItem.uid), newItem);
