...
import { getCategoryLevel } from '@/lib/blog/category-utils.client';

type Props = {
  row: IBlogCategoryListRow;
  setSelectedRow: (row: IBlogCategory) => void;
...
const ListRow = ({
  ...
  const editUrl = getRouteUrl('blogCategory.edit', locale, { id: row.uid });
