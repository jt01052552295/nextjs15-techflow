...
import {
  UpdateType,
  UpdateSchema,
} from '@/actions/blog/category/update/schema';
import { updateAction } from '@/actions/blog/category/update';
import {
  FormProvider,
  SubmitHandler,
  useForm,
...
import ResultConfirm from '@/components/blog/category/modal/ResultConfirm';
    ...
    startTransition(async () => {
      try {
        ...
        if (response.status == 'success') {
          const updatedItem = response.data as IBlogCategory;
          ...
          queryClient.setQueryData(
            blogCategoryQK.detail(updatedItem.uid),
            updatedItem,
          );
          queryClient.invalidateQueries({ queryKey: ['blogCategory', 'list'] });
        } else {
                ...
                <div className="card-body">
                  <div className="row">
                    <div className="col">
                      <div className="mb-2">
                        <FormTextField
                          label={t('columns.blogCategory.code')}
                          name="code"
                          register={register}
                          error={errors?.code}
                      ...
                      <div className="mb-2">
                        <FormTextField
                          label={t('columns.blogCategory.name')}
                          name="name"
                          register={register}
                          error={errors?.name}
                          validMessage={t('common.form.valid')}
                      ...
                      <div className="mb-2">
                        <FormTextField
                          label={t('columns.blogCategory.slug')}
                          name="slug"
                          register={register}
                          error={errors?.slug}
                          validMessage={t('common.form.valid')}
                ...
                <div className="card-body">
                  <div className="row">
                    <div className="col">
                      <div className="mb-2">
                        <FormTextField
                          label={t('columns.blogCategory.desc')}
                          name="desc"
                          register={register}
                          error={errors?.desc}
                          validMessage={t('common.form.valid')}
                      ...
                      <div className="mb-2">
                        <FormSwitch
                          label={t('columns.blogCategory.isUse')}
                          name={`isUse` as any}
                          register={register}
                          error={errors?.isUse}
                      ...
                      <div className="mb-2">
                        <FormSwitch
                          label={t('columns.blogCategory.isVisible')}
              ...
              <div className="row justify-content-between align-items-center mt-3 mb-3">
                ...
                <div className="col-auto">
                  ...
                  <Link
                    ...
                    href={`${getRouteUrl('blogCategory.index', locale)}?${searchParams.toString()}`}
                  >
