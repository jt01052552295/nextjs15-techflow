...
import { CreateType, CreateSchema } from '@/actions/shop/order/create/schema';
import { createAction } from '@/actions/shop/order/create';
import { SubmitHandler, useForm, FormProvider } from 'react-hook-form';
import { zodResolver } from '@hookform/resolvers/zod';
import useFormUtils from '@/hooks/useFormUtils';
import ResultConfirm from '@/components/shop/order/modal/ResultConfirm';
    ...
    startTransition(async () => {
      try {
        ...
        if (response.status == 'success') {
          ...
          queryClient.invalidateQueries({ queryKey: ['shopOrder', 'list'] });

          // 상세로 이동
          // const qs = searchParams.toString();
          // queryClient.setQueryData(shopOrderQK.detail(newItem.uid), newItem);
                    ...
                    <div className="col">
                      <div className="mb-2">
                        <ShopCategorySelect
                          ...
                          control={control}
                          label={t('columns.shopOrder.categoryCode')}
                          required
                      ...
                      <div className="mb-2">
                        <FormTextField
                          label={t('columns.shopOrder.code')}
                          name="item.code"
                          register={register}
                      ...
                      <div className="mb-2">
                        <FormTextarea
                          label={t('columns.shopOrder.desc1')}
                          name="item.desc1"
                          register={register}
                      ...
                      <div className="mb-2">
                        <FormTextField
                          label={t('columns.shopOrder.basicPriceDc')}
                      ...
                      <div className="mb-2">
                        <FormTextField
                          label={t('columns.shopOrder.salePrice')}
                          name="item.salePrice"
                          register={register}
                      ...
                      <div className="mb-2">
                        <FormTextField
                          label={t('columns.shopOrder.useDuration')}
                      ...
                      <div className="mb-2">
                        <FormSelect
                          label={t('columns.shopOrder.orderMinimumCnt')}
                      ...
                      <div className="mb-2">
                        <FormSelect
                          label={t('columns.shopOrder.orderMaximumCnt')}
                ...
                <div className="card-body">
                  <div className="row">
                    <div className="col">
                      <div className="mb-2">
                        <FormEditor
                          label={t('columns.shopOrder.basicDesc')}
                          name="item.basicDesc"
                          control={control}
