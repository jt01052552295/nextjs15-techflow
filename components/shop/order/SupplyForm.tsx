  ...
  return (
    <div className="card">
      <div className="card-header d-flex justify-content-between align-items-center">
        <h5 className="card-title m-0">{t('columns.shopOrderSupply.t')}</h5>
      </div>
        ...
        {fields.map((field, index) => (
          <div key={field.id} className="row g-2 mb-3 pb-3 border-bottom">
            <div className="col-md-2">
              <FormTextField
                label={t('columns.shopOrderSupply.gubun')}
            ...
            <div className="col-md-2">
              <FormTextField
                label={t('columns.shopOrderSupply.choiceType')}
            ...
            <div className="col-md-3">
              <FormTextField
                label={t('columns.shopOrderSupply.name')}
            ...
            <div className="col-md-2">
              <FormTextField
                label={t('columns.shopOrderSupply.price')}
            ...
            <div className="col-md-2">
              <FormTextField
                label={t('columns.shopOrderSupply.stock')}
            ...
            <div className="col-md-2">
              <FormSwitch
                label={t('columns.shopOrderSupply.isUse')}
            ...
            <div className="col-md-2">
              <FormSwitch
                label={t('columns.shopOrderSupply.isVisible')}
            ...
            <div className="col-md-2">
              <FormSwitch
                label={t('columns.shopOrderSupply.isSoldout')}
