  ...
  return (
    <div className="card">
      <div className="card-header d-flex justify-content-between align-items-center">
        <h5 className="card-title m-0">{t('columns.shopOrderOption.t')}</h5>
      </div>
        ...
        {fields.map((field, index) => (
          <div key={field.id} className="row g-2 mb-3 pb-3 border-bottom">
            <div className="col-md-2">
              <FormTextField
                label={t('columns.shopOrderOption.gubun')}
            ...
            <div className="col-md-2">
              <FormTextField
                label={t('columns.shopOrderOption.choiceType')}
            ...
            <div className="col-md-3">
              <FormTextField
                label={t('columns.shopOrderOption.name')}
            ...
            <div className="col-md-2">
              <FormTextField
                label={t('columns.shopOrderOption.price')}
            ...
            <div className="col-md-2">
              <FormTextField
                label={t('columns.shopOrderOption.stock')}
            ...
            <div className="col-md-1">
              <FormTextField
                label={t('columns.shopOrderOption.buyMin')}
            ...
            <div className="col-md-1">
              <FormTextField
                label={t('columns.shopOrderOption.buyMax')}
            ...
            <div className="col-md-2">
              <FormSwitch
                label={t('columns.shopOrderOption.isUse')}
            ...
            <div className="col-md-2">
              <FormSwitch
                label={t('columns.shopOrderOption.isVisible')}
            ...
            <div className="col-md-2">
              <FormSwitch
                label={t('columns.shopOrderOption.isSoldout')}
