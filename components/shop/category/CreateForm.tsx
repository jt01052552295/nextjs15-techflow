...
import {
  CreateType,
  CreateSchema,
} from '@/actions/shop/category/create/schema';
import { createAction } from '@/actions/shop/category/create';
    ...
    startTransition(async () => {
      try {
        ...
        if (response.status == 'success') {
          ...
          // queryClient.setQueryData(shopCategoryQK.detail(newItem.uid), newItem);
