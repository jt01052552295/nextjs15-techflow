...
import { show } from '@/services/shop/order.service';
import { __ts } from '@/utils/get-dictionary';
import { ckLocale } from '@/lib/cookie';
// ITodosPart가 있다면 그대로 반환 타입에 사용
import type { IShopOrderListRow } from '@/types/shop/order';

export async function showAction(uid: string): Promise<IShopOrderListRow> {
  ...
  try {
    ...
    return rs as unknown as IShopOrderListRow;
  } catch (err: any) {
