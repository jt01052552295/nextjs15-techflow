...
export const DEFAULTS: BlogCategoryBaseParams = {
  sortBy: 'code',
  order: 'asc',
  limit: 20,
};
...
export function isSameBaseParams(
  a: BlogCategoryBaseParams,
  b: BlogCategoryBaseParams,
) {
  return (
    norm(a.q) === norm(b.q) &&
