...
export const DEFAULTS: BlogTagBaseParams = {
  sortBy: 'idx',
  order: 'desc',
  limit: 20,
};
...
export function toBaseParamsFromSearch(sp: URLSearchParams): BlogTagBaseParams {
...
export function toSearchParamsFromBase(p: BlogTagBaseParams): URLSearchParams {
...
export function isSameBaseParams(a: BlogTagBaseParams, b: BlogTagBaseParams) {
  return (
    norm(a.q) === norm(b.q) &&
