...
export const DEFAULTS: PopupBaseParams = {
  sortBy: 'idx',
  order: 'desc',
  limit: 20,
};
...
export function toBaseParamsFromSearch(sp: URLSearchParams): PopupBaseParams {
...
export function toSearchParamsFromBase(p: PopupBaseParams): URLSearchParams {
...
export function isSameBaseParams(a: PopupBaseParams, b: PopupBaseParams) {
  return (
    norm(a.q) === norm(b.q) &&
