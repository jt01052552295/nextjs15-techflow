...
export const DEFAULTS: BannerBaseParams = {
  sortBy: 'sortOrder',
  order: 'desc',
  limit: 20,
};
...
export function toBaseParamsFromSearch(sp: URLSearchParams): BannerBaseParams {
...
export function toSearchParamsFromBase(p: BannerBaseParams): URLSearchParams {
...
export function isSameBaseParams(a: BannerBaseParams, b: BannerBaseParams) {
  return (
    norm(a.q) === norm(b.q) &&
