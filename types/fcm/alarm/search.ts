...
export const DEFAULTS: FcmAlarmBaseParams = {
  sortBy: 'idx',
  order: 'desc',
  limit: 20,
};
...
export function toSearchParamsFromBase(p: FcmAlarmBaseParams): URLSearchParams {
...
export function isSameBaseParams(a: FcmAlarmBaseParams, b: FcmAlarmBaseParams) {
  return (
    norm(a.q) === norm(b.q) &&
