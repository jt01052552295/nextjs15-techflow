...
export const DEFAULTS: FcmTokenBaseParams = {
  sortBy: 'idx',
  order: 'desc',
  limit: 20,
};

const sortBySet = new Set(['idx']);
...
export function toSearchParamsFromBase(p: FcmTokenBaseParams): URLSearchParams {
...
export function isSameBaseParams(a: FcmTokenBaseParams, b: FcmTokenBaseParams) {
  return (
    norm(a.q) === norm(b.q) &&
