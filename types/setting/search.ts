...
export const DEFAULTS: SettingBaseParams = {
  sortBy: 'idx',
  order: 'desc',
  limit: 20,
};
...
export function toBaseParamsFromSearch(sp: URLSearchParams): SettingBaseParams {
...
export function toSearchParamsFromBase(p: SettingBaseParams): URLSearchParams {
...
export function isSameBaseParams(a: SettingBaseParams, b: SettingBaseParams) {
  return (
    norm(a.q) === norm(b.q) &&
