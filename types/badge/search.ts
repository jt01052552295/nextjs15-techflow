...
export const DEFAULTS: BadgeBaseParams = {
  sortBy: 'idx',
  order: 'desc',
  limit: 20,
};
...
export function toBaseParamsFromSearch(sp: URLSearchParams): BadgeBaseParams {
...
export function toSearchParamsFromBase(p: BadgeBaseParams): URLSearchParams {
...
export function isSameBaseParams(a: BadgeBaseParams, b: BadgeBaseParams) {
  return (
    norm(a.q) === norm(b.q) &&
