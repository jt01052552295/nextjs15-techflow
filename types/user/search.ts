...
export const DEFAULTS: UserBaseParams = {
  sortBy: 'idx',
  order: 'desc',
  limit: 20,
};

const sortBySet = new Set(['idx', 'name', 'email', 'createdAt', 'updatedAt']);
...
export function toBaseParamsFromSearch(sp: URLSearchParams): UserBaseParams {
...
export function toSearchParamsFromBase(p: UserBaseParams): URLSearchParams {
...
export function isSameBaseParams(a: UserBaseParams, b: UserBaseParams) {
  return (
    norm(a.q) === norm(b.q) &&
