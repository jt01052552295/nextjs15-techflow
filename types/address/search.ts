...
export const DEFAULTS: AddressBaseParams = {
  sortBy: 'idx',
  order: 'desc',
  limit: 20,
};
...
export function toBaseParamsFromSearch(sp: URLSearchParams): AddressBaseParams {
...
export function toSearchParamsFromBase(p: AddressBaseParams): URLSearchParams {
...
export function isSameBaseParams(a: AddressBaseParams, b: AddressBaseParams) {
  return (
    norm(a.q) === norm(b.q) &&
