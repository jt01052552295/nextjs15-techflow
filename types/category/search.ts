...
export const DEFAULTS: CategoryBaseParams = {
  sortBy: 'code',
  order: 'asc',
  limit: 20,
};

const sortBySet = new Set(['idx', 'name', 'code', 'createdAt', 'updatedAt']);
...
export function toSearchParamsFromBase(p: CategoryBaseParams): URLSearchParams {
...
export function isSameBaseParams(a: CategoryBaseParams, b: CategoryBaseParams) {
  return (
    norm(a.q) === norm(b.q) &&
