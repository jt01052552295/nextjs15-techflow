...
export const DEFAULTS: AgentBaseParams = {
  sortBy: 'idx',
  order: 'desc',
  limit: 20,
};

const sortBySet = new Set(['idx', 'createdAt']);
...
export function toBaseParamsFromSearch(sp: URLSearchParams): AgentBaseParams {
...
export function toSearchParamsFromBase(p: AgentBaseParams): URLSearchParams {
...
export function isSameBaseParams(a: AgentBaseParams, b: AgentBaseParams) {
  return (
    norm(a.q) === norm(b.q) &&
