...
import ListForm from '@/components/bbs/ListForm';
import type { SortBy, SortOrder } from '@/types/bbs';
...
import { bbsQK, type BbsBaseParams } from '@/lib/queryKeys/bbs';
...
export default async function Page({ params, searchParams }: Props) {
  ...
  const baseParams: BbsBaseParams = {
